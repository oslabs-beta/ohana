  ...
  return (
    <div id='leftPaneNav' className='shadow'>
      ...
      <Box
        ...
        minHeight='80vh'
      >
        <Box minHeight='10vh' maxHeight='25vh' paddingLeft='1em'>
          <Box>
            <h3>General</h3>
          </Box>
          ...
          >
            <Box>
              <Link to='/home'>
                <Button color='primary.text.secondary'>Home</Button>
              </Link>
            </Box>
            <Box>
              <Link to='/vcluster'>
                <Button color='primary.contrastText'>vClusters</Button>
              </Link>
            </Box>
            <Box>
              <Link to='/spaces'>
                <Button color='primary.text.secondary'>Spaces</Button>
              </Link>
            </Box>
            <Box>
              <Link to='/deploy'>
                <Button color='primary.text.secondary'>Deploy</Button>
              </Link>
            </Box>
          </Box>
        </Box>
        <Box minHeight='0' maxHeight='20vh' paddingLeft='1em'>
          <Box>
            <h3>Support</h3>
          </Box>
          <Box
          ...
          <Box marginLeft='-1em'>{adminPane}</Box>
        </Box>
      </Box>
    </div>
  );
